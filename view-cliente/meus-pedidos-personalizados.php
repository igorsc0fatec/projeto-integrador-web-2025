                    ...
                    <div class="pedido">
                        ...
                        <div class="botoes">
                            ...
                            <?php if ($pedido['tipo_status'] !== 'Cancelado pelo Cliente!' && $pedido['tipo_status'] !== 'Entregue!'): ?>
                                <button type="button" onclick="confirmarCancelamento(<?= $pedido['id_pedido_personalizado'] ?>)" class="btn-cancelar">
        ...
        function confirmarCancelamento(idPedido) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('meus-pedidos-personalizados.php', {
                            method: 'POST',
                            body: formData
                        })
