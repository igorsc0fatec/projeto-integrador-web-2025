...
<div class="content-header">
    <h2><i class="fas fa-user-plus"></i> Cadastrar Nova Confeitaria</h2>
    <p>Preencha os dados abaixo para cadastrar um nova confeitaria no sistema.</p>
</div>
...
<div class="form-container">
    <form id="form-novo-adm" method="POST">
        <div class="form-section">
            <h3><i class="fas fa-user"></i> Dados da Confeitaria</h3>
            <div class="form-group">
                <label for="nome">Nome da Confeitaria:</label>
                <input id="nomeConfeitaria" type="text" name="nomeConfeitaria" placeholder="Digite o Nome da Confeitaria" required>
            </div>
            
            <div class="form-group">
                <label for="cnpj">CNPJ:</label>
                <input id="cnpjConfeitaria" type="text" name="cnpjConfeitaria" placeholder="Digite o CNPJ" required>
            </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn-submit" id="cadastrarConfeitaria" name="cadastrarConfeitaria">Cadastrar</button>
        </div>
    </form>
</div>
