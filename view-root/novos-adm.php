...
<div class="content-header">
    ...
    <p>Preencha os dados abaixo para cadastrar um novo administrador no sistema.</p>
</div>
    ...
    <form id="form-novo-adm" method="POST">
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input id="nomeAdm" type="text" name="nomeAdm" placeholder="Digite o Nome do Administrador" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input id="funcaoAdm" type="text" name="funcaoAdm" placeholder="Digite a Função" required>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn-submit" id="cadastrar" name="cadastrar">Cadastrar</button>
        </div>
    </form>
</div>
