        ...
        <div>
            <div class="ag-courses_box">
                <div class="ag-courses_item">
                    <a href="editar-confeitaria-root.php" class="ag-courses-item_link">
                ...
                <div class="ag-courses_item">
                    <a href="telefone-confeitaria-root.php" class="ag-courses-item_link">
                        <div class="ag-courses-item_bg"></div>
                        <div class="ag-courses-item_title">
                            Telefones
                        </div>
                ...
                <div class="ag-courses_item">
                    <a href="produtos-root.php" class="ag-courses-item_link">
                        <div class="ag-courses-item_bg"></div>
                        <div class="ag-courses-item_title">
                            Produtos
                        </div>
                ...
                <div class="ag-courses_item">
                    <a href="personalizados-root.php" class="ag-courses-item_link">
                        <div class="ag-courses-item_bg"></div>
                        <div class="ag-courses-item_title">
