...
<body>
    ...
    $delete = new Delete();
    $deleteTelefone = $delete->deletarTelConfeitaria();
    ?>
            ...
            <tbody id="telefones">
                ...
                <?php else: ?>
                    <?php foreach ($telefones as $t): ?>
                        <tr>
                            <td>
                                <?php echo $t['numTelConfeitaria']; ?>
                            </td>
                            <td>
                                <?php echo $t['tipoTelefone']; ?>
                            </td>
                            <td><?php echo "<a href=\"$deleteTelefone?id={$t['idTelConfeitaria']}\" onClick=\"return confirm('Tem certeza que deseja excluir?' )\">Excluir</a>" ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
