...
<body>
    ...
    <div>
        <h2>Sua lista de Coberturas</h2>

        <form id="search-form" method="post">
            <div class="pesquisa">
                <label for="pesq">Buscar Cobertura</label>
                <div class="input-wrapper">
                    <input id="pesq" type="text" name="pesq" placeholder="Digite o nome da cobertura/ex: chocolate"
                        required>
