...
<body>
            ...
            <nav>
                <div class="nav-container">
                    ...
                    <ul class="nav-links">
                        ...
                        <li><a href="cadastrar-recheio.php">Voltar </a></li>
                    </ul>
                </div>
            </nav>
        </header>
    ...
    if (isset($_POST['submit'])) {
        if ($recheioController->verificaEditRecheio()) {
            if ($recheioController->updateRecheio()) {
                echo "
                    <script>
                        Swal.fire({
                        title: 'Recheio editado com sucesso!',
                        icon: 'success',
        ...
        } else if ($recheioController->verificaRecheio()) {
            echo "
                    <script>
                        Swal.fire({
                        title: 'Erro ao editar recheio!',
